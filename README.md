...
* `GenerateFisherNoise(string meshDir, double d1, double d2, int noiseDirection, int seed)` -- generates node noise distributed by PDF: $(x | d_{1}, d_{2}) = \sqrt{\frac{(d_{1} x)^{d_{1}} d^{d_{2}}_{2}
* }{(d_{1} x + d_{2})^(d_{1} + d_{2})} / (x B(\frac{d_{1}}{2}, \frac{d_{2}}{2}))$.Here $B$ is beta function.
